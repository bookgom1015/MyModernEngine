#ifndef __D3D12BLENDSCATTERING_HLSL__
#define __D3D12BLENDSCATTERING_HLSL__
...
Texture3D<VolumetricLight::FrustumVolumeMapFormat> gi_PreviousFrame : register(t0);

RWTexture3D<VolumetricLight::FrustumVolumeMapFormat> gio_CurrentFrame : register(u0);
...
#endif // __D3D12BLENDSCATTERING_HLSL__