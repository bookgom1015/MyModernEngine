...
RWStructuredBuffer<EyeAdaption::HistogramBin> gi_Histogram : register(u0);
RWStructuredBuffer<EyeAdaption::Result>       go_Output    : register(u1);
